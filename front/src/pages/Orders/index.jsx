...
function Orders() {
  ...
  const handlePaymentUpdate = (orderId, newPaymentStatus) => {
    dispatch(updateOrder({ id: orderId, orderData: { paymentStatus: newPaymentStatus } }))
  }
    ...
    <div className="dashboard-layout">
      ...
      <div className="dashboard-content">
        ...
        <div className="orders-filters">
          ...
          >
            Pagamento Pendente ({orders.filter(o => o.paymentStatus === 'Pendente').length})
          </button>
          <button 
            ...
            <div className="orders-grid">
              {filteredOrders.map(order => (
                <div key={order.id} className="order-card">
                  ...
                  {order.paymentStatus === 'Pago' && order.status !== 'Entregue' && order.status !== 'Cancelado' && (
